  ...
  <div class="row">
    <div class="col-md-12">
        <ul class="nav nav-pills">
          <li ><a href="{{ URL::to('fabric/'.$fabric->id) }}">{{$fabric->cal_code}}</a></li>
          <li ><a href="{{ URL::to('debit/'.$fabric->id) }}">Debit</a></li>
          <li class="active"><a href="{{ URL::to('credit/'.$fabric->id) }}">Credit</a></li>
        </ul>          
    </div>
  </div>
</div>   
...
<div class="col-md-6">
      ...
      id="my-awesome-dropzone" role="form" action="credit" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group  
    ...
    <div class="col-md-12">
      ...
      <div class="col-sm-10">
       ...
       <input type="hidden" name="cal_code" value="{{$fabric->cal_code}}">
        <div class="form-group">
          <div class="col-md-12">
